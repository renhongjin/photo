...
public class ImageUtils {  
  ...
  public static void main(String[] args) {  
      // 1-缩放图像：  
      // 方法一：按比例缩放  
      ImageUtils.scale("D:/imgs/abc.jpg", "D:/imgs/abc_scale.jpg", 2, true);//测试OK  
      // 方法二：按高度和宽度缩放  
      ImageUtils.scale2("D:/imgs/photo/2016/08/13/57aeda09f870b3e02f940574.jpg", "D:/imgs/photo/2016/08/13/abc_scale2.jpg", 300, 300, true);//测试OK  

      // 2-切割图像：  
      // 方法一：按指定起点坐标和宽高切割  
      ImageUtils.cut("D:/imgs/abc.jpg", "D:/imgs/abc_cut.jpg", 0, 0, 400, 400);//测试OK  
      // 方法二：指定切片的行数和列数  
      ImageUtils.cut2("D:/imgs/abc.jpg", "D:/imgs/", 2, 2);//测试OK  
      // 方法三：指定切片的宽度和高度  
      ImageUtils.cut3("D:/imgs/abc.jpg", "D:/imgs/", 300, 300);//测试OK  

      // 3-图像类型转换：  
      ImageUtils.convert("D:/imgs/abc.jpg", "GIF", "D:/imgs/abc_convert.gif");//测试OK  

      // 4-彩色转黑白：  
      ImageUtils.gray("D:/imgs/abc.jpg", "D:/imgs/abc_gray.jpg");//测试OK  

      // 5-给图片添加文字水印：  
      // 方法一：  
      ImageUtils.pressText("我是水印文字", "D:/imgs/abc.jpg", "D:/imgs/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80, 0, 0, 0.5f);//测试OK  
      // 方法二：  
      ImageUtils.pressText2("我也是水印文字", "D:/imgs/abc.jpg", "D:/imgs/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK  

      // 6-给图片添加图片水印：  
      ImageUtils.pressImage("D:/imgs/abc2.jpg", "D:/imgs/abc.jpg", "D:/imgs/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK  
  }  
